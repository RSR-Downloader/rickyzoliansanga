...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➕ Add Me to Your Group 🎨", url="t.me/rsrmusic?startgroup=true"
        ),
    ],
]
...
Hexzy_IMG = "https://1.bp.blogspot.com/-EQt2ZDkVjBo/Xxh2VMVfKMI/AAAAAAAAABM/k7vSi2w3iqoacCD4KVQ1_B3k2APLFfSywCLcBGAsYHQ/s1600/FB_IMG_1579930873363.jpg"
...
def Hexzy_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [RSR](https://github.com/RSR-Downloader/rickyzoliansanga) + [Mami](https://github.com/RSR-Downloader/mizokani) ."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by RSR"
